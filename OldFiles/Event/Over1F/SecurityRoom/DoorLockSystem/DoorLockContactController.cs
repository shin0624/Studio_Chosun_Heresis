...
{
    public string DoorLockPrefabPath = "Prefabs/DoorLockSystem/DoorLockCanvas";//ui 프리팹 경로
...
//리소스 매니저를 사용한 프리팹 불러오기 : 이렇게 쓰면 좋긴 한데 한번 비밀번호 정답을 입력해버리면 게임을 다시 시작해도 문이 안열려버림
        //DoorLockUIInstance = Managers.Resource.Instantiate(DoorLockPrefabPath);//매너저스의 리소스를 통해 프리팹을 로드하고 인스턴스 생성
        //if(DoorLockUIInstance ==null)//널체크 수행
        //{
        ...
        //DoorLockController.OnDoorLockClosed += DeactivateDoorLockUI;//도어락컨트롤러의 이벤트 구독
#endif
